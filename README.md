...
3. [F#](source/basic/hello_world.fs) - [Fsharp.org](https://fsharp.org/)
...
1. [GDScript](source/basic/hello_world.gd) - [Godot Engine](https://docs.godotengine.org/en/stable/tutorials/scripting/gdscript/index.html)
2. [Go](source/basic/hello_world.go) - [Go.dev](https://go.dev/)
3. [Groovy](source/basic/hello_world.groovy) - [Groovy-lang.org](https://groovy-lang.org/)
